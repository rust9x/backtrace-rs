...
windows_link::link!("dbghelp.dll" "system" fn SymFromAddr(hprocess : HANDLE, address : u64, displacement : *mut u64, symbol : *mut SYMBOL_INFO) -> BOOL);
...
windows_link::link!("dbghelp.dll" "system" fn SymGetLineFromAddr64(hprocess : HANDLE, qwaddr : u64, pdwdisplacement : *mut u32, line64 : *mut IMAGEHLP_LINE64) -> BOOL);
...
windows_link::link!("dbghelp.dll" "system" fn SymInitialize(hprocess : HANDLE, usersearchpath : PCSTR, finvadeprocess : BOOL) -> BOOL);
